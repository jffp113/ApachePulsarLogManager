...
./bin/pulsar-admin functions create --classname MetricProcessorFunction --jar MetricProcessorFunction-1.0-SNAPSHOT.jar --log-topic persistent://public/default/logging-metrics-processing-function-logs  --inputs persistent://public/default/index_metrics_processing  --tenant public --processing-guarantees EFFECTIVELY_ONCE --subs-position Earliest --subs-name metricsSub --namespace default && \
exit
"
